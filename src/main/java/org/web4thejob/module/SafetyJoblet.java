...
@Component
public class SafetyJoblet extends AbstractJoblet {
	...
	public String[] getSchemas() {
		return new String[] { "WebForTheJobSafety" };
	}
	...
	public List<Resource> getResources() {
		...
		try {
			for (Resource resource : resolver
					.getResources("classpath*:com/safetyjoblet/**/*.hbm.xml")) {
